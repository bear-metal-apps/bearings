...
final currentEventMatchesProvider = FutureProvider<List<Map<String, dynamic>>>((ref) async {
...
final teamMatchesProvider = FutureProvider.family<List<Map<String, dynamic>>, String>((ref, teamKey) async {
  final client = ref.watch(honeycombClientProvider);
...
final filteredMatchesProvider = Provider<AsyncValue<List<Map<String, dynamic>>>>((ref) {
